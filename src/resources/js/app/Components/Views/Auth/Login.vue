        ...
        <div class="login-form d-flex align-items-center">
          ...
          >
            <div class="text-center mb-4">
              <img
                :src="urlGenerator(configData.company_logo)"
                alt=""
            ...
            >
              <a
                :href="urlGenerator('/forget-password')"
                class="
                  bluish-text
                  d-flex
                  align-items-center
...
export default {
  ...
  methods: {
    ...
    setUserInfo() {
      let selectUser = this.userTypeList.find(
        (user) => user.id == this.userRole
      );
